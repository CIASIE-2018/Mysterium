...
game = play(game, game.mediums[1].username, game.mediums[1].scenario.arme);
game = play(game, game.mediums[2].username, game.mediums[2].scenario.arme);
